DROP DATABASE IF EXISTS periyar_univ;
CREATE DATABASE periyar_univ;
USE periyar_univ;


-- 1. Create All Tables (Schema-aligned with SQLAlchemy models)
...
INSERT INTO alembic_version (version_num) VALUES ('951040a1033e');

-- 2. Clear existing records for clean seeding
SET FOREIGN_KEY_CHECKS = 0;
TRUNCATE TABLE department_sections;
TRUNCATE TABLE department_nav_links;
TRUNCATE TABLE faculties;
TRUNCATE TABLE alumni_tables;
